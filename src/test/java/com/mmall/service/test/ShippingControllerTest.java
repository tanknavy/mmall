...
public class ShippingControllerTest {
    ...
    public void setUp() throws Exception{
        ...
        mockMvc = MockMvcBuilders.standaloneSetup(shippingController).build();
        //mockMvc = MockMvcBuilders.webAppContextSetup(context).build();
    }

    private String url = "/shipping/list.do"; //list.do
    ...
    public void productControllerTest() throws Exception{
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.get(url, 28) //(url, Object...)无限量argument
