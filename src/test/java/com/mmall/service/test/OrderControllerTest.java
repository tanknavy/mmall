...
public class OrderControllerTest {
    ...
    // /pay.do/alipay_callback.do/query_order_pay_status.do
    // /order/detail.do
    // /manage/order/list.do
    private String url = "/order/detail.do"; //pay.do/alipay_callback.do/query_order_pay_status.do
    ...
    public void productControllerTest() throws Exception{
        ...
        //this.mockMvc.perform(MockMvcRequestBuilders.get("/order/pay.do")
        this.mockMvc.perform(MockMvcRequestBuilders.get(url, Long.parseLong("1492091102371")) //(url, Object...)无限量argument
